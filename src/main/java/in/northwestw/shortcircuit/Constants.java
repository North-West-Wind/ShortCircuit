...
public class Constants {
    ...
    public static final ResourceKey<Level> RUNTIME_DIMENSION = ResourceKey.create(Registries.DIMENSION, ResourceLocation.fromNamespaceAndPath(ShortCircuit.MOD_ID, "runtime"));
}
